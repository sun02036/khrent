...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="include page" name="title"/>
</jsp:include>
					...
					<div class="tab_cont">
						...
						<div class="tab inland active">
							<div class="search_form">
								<form
									action="${pageContext.request.contextPath}/reservation/carSearch"
...
<section class="board_area" id="board_area">
	<div class="wrap">
		...
		<!-- .latestBoard -->
			...
			<div class="latestBoard">
				<a href="${pageContext.request.contextPath}/board/questionList" class="boardTitle">
					<p>
